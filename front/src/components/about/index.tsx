...
export const AboutUs = () => {const teamMembers = [
...
const teamMembers4 = [
    ...
    { name: "עידן מור (גדי וילצ׳רסקי)", role: "מרצה על צמיחה מפוסט טראומה", image: Idan },
    { name: "גיא פליקסבורדט", role: "הריאציה ותודעה לצמיחה מטראומה", image: Guy }
];

const therapists = [
    { name: "אסתר פנחס", role: "טווינה, דיקור וצמחים", image: Ester },
    { name: "חוטי סהר בן טוב", role: "שיאצו, יוגה", image: Tuti },
    { name: "שרונה שביב", role: "איורוודה, רפואה הודית מסורתית", image: Sharona },
    { name: "קרינה רוזנבאום", role: "עיסוי תאילנדי", image: Karina },
    { name: "איתי פוטר", role: "אבחה ואמפקון, טכניקות מגע יפניות", image: Itay }
];
    return (<>
        <main>
            <h2 className="orange">מי אנחנו</h2>
            <h1 className="brown"  style={{marginBlock:0}}>מייסדי העמותה</h1>
            ...
            <div style={{ display: 'flex', gap: '10%', justifyContent: 'center' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', maxWidth: '400px' }}>
                    <img 
                        ...
                        />
                    <h2 className="orange" style={{marginBlock:0}}>ניצן קרן</h2>
                    <h3 className="orange" >יזם ומנהל הפקה</h3>
                    <h4 className="brown">
                        בעלים של חברת הפקה המתמחה בהפקת אירועים לחברות וארגונים בינלאומיים. 
                        מתמחה ביצירת מרחבים, ריטריטים שקשורים לרוח ותודעה, אחד מהמפיקים של זואי ריטריט מהנבחרים בארץ.
                    </h4>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', maxWidth: '400px' }}>
                    ...
                    <h3 className="orange" style={{marginBlock:0}}>יזמית ומנהלת קלינית ותכנים</h3>
                    <h4 className="brown">
                        פסיכולוגית קלינית. מומחית בטיפול במצבי קיצון עם רקע עשיר של טיפול וניהול צוותים טיפוליים במסגרות שונות: צבא,
                        קהיליית המודיעין, בית מאזן ועוד. זאת לצד ניסיון טיפולי רב בעבודת גוף-נפש, מסעות בטבע והכשרה של טיפול באמצעות חומרים משני תודעה. 
                        לצד הטיפול האישי, יוזמת ומאמינה במרחבי ריפוי. הייתה שותפה בין השאר בהקמת 'גאגא', "בין הצללים", ו'רוקדים שבעה', העוסק בהתמודדות עם מוות ואובדן.
                    </h4>
                </div>
            </div>
        </main>
           ...
           <h2 className="orange">מי אנחנו</h2>
           <h1 className="brown"  style={{marginBlock:0}}>שותפים לניהול </h1>
 {/* קונטיינר של שני המייסדים */}
 <div style={{ display: 'flex', gap: '10%', justifyContent: 'center' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', maxWidth: '400px' }}>
                    <img 
                        ...
                        style={{ width: 284, height: 279, borderRadius: "50%" }} 
                        />
                    <h2 className="orange" style={{marginBlock:0}}>עמרי רוסו                    </h2>
                    <h3 className="orange" >מנהל תפעול  </h3>
                    <h4 className="brown">
                    לומד, מתרגל ומלמד קצת יותר מעשור את הדרך הבודהיסטית, הגישה הלא-דואלית ותפיסות רוחניות נוספות. מטפל ברפואה סינית: דיקור, טווינה וצמחים, בפסיכולוגיה רוחנית ובעזרת סוסים. מלווה תהליכים אישיים וקבוצתיים דרך אספקטים של גוף-נפש-רוח וחקירה מבוססת מיינדפולנס. מתוך תהליכים אישיים שעבר בחייו, יש לו חיבור מיוחד בהתעמקות בתהליכי אבל ושכול וליווי אנשים במצבי קיצון וטראומה.
                    </h4>
                </div>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', maxWidth: '400px' }}>
                    <img 
                        ...
                        style={{ width: 284, height: 279, borderRadius: "50%" }} 
                        />
                    <h2 className="orange">ליאור גולדברג
                    </h2>
                    <h3 className="orange" style={{marginBlock:0}}>מנהלת קהילה                    </h3>
                    <h4 className="brown">
                    אשת טבע, חינוך, יצירה וטיפול. מנהלת קהילה ומלווה תהליכי ריפוי דרך חיבור עמוק לטבע ולעצמי.
                    מאמינה ביצירת מרחבי קהילה רב תחומיים המשלבים תרבות, אומנות ושיח                    </h4>
                </div>
            </div>
           </main>
           <main>
           <h2 className="orange" style={{marginBlock:0}}>מעטפת אנושית </h2>
           <h1 className="brown"  style={{marginBlock:0}}>  ההפקה ומאחורי הקלעים</h1>
        <section className="team-container2">
            <div className="team-grid2">
                {teamMembers.map((member, index) => (
                    <div key={index} className="team-member2">
                        <img src={member.image} alt={member.name} className="team-image2" />
           ...
           <h2 className="orange" style={{marginBlock:0}}>  מטפלים בכירים</h2>
           <h1 className="brown"  style={{marginBlock:0}}> שותפים קלינים ומנחי סדנאות</h1>
        ...
        <main>
           <h2 className="orange" style={{marginBlock:0}}>  מעטפת אנושית </h2>
           <h1 className="brown"  style={{marginBlock:0}}> עיניים מלוות</h1>
           <h3 className="brown">  כל משתתף בריטריט מלווה על ידי אנשי טיפול שתפקידם להיות "עיניים מלוות" לאורך כל הסדנה מקבלת הפנים ועד סיום הריטריט.
במהלך הריטריט המלווה פוגש את המשתתפים בקבוצה קטנה ומלווה אותם בתהליך. בנוסף, תפקידו לזהות מצבים מורכבים, לתת מענה או להפנות לאיש טיפול בכיר יותר. לקראת סוף הריטריט מסייע בהכוונה ליציאה רכה אל העולם והמשך טיפול באחד מהכלים שבהם התנסה המשתתף בסדנה.</h3>
...
<main>
<h2 className="orange" style={{marginBlock:0}}>  סדנאות  </h2>
           <h1 className="brown"  style={{marginBlock:0}}> מגוון שפות וכלים</h1>
           <h3 className="brown"> במהלך הריטריט המשתתפים נחשפים לעבודה רגשית ומשאוב דרך כלים של קול, תנועה, מגע, מוסיקה, אומנות, כתיבה, מלאכות עתיקות, טבע ועוד.
הכוונה היא לתת לכל אדם את הביטוי והעבודה בשפה שלו ולהחשף למגוון כלים חדשים.</h3>
...
<main>
<h2 className="orange" style={{marginBlock:0}}>  המיכל  </h2>
<h1 className="brown"  style={{marginBlock:0}}> מטפלי גוף</h1>
        <section className="team-container2">
            <div className="team-grid2">
    ...
    <main>
        ...
        <h5>
        שניר מחלוף, אילנה בן אמיר, גל פסח, יואל ויברה, דוד רוזנברג, גלעד תלמי, יונתן סולז׳, אפרת גולדברג, רינת לפידות
</h5>
<h4 className="orange">
וועד מנהל
</h4>
<h5>
גיא מלל ואביעד פינטו 
</h5>
<h4 className="orange">
וועדת ביקורת
</h4>
<h5>גל פסח ורינת לפידות
</h5>
    </main>
          </>
    );
